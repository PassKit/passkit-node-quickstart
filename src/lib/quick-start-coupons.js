...
const {
  CouponCampaign,
} = require("passkit-node-sdk/io/single_use_coupons/campaign_pb");
const {
  CouponOffer,
} = require("passkit-node-sdk/io/single_use_coupons/offer_pb");
const {
  ListRequest,
  Coupon,
} = require("passkit-node-sdk/io/single_use_coupons/coupon_pb");
...
class QuickStartCoupons {
  ...
  async runQuickStart() {
    try {
      ...
      throw new Error(`Coupons quickstart failed: ${error.message}`, {
        cause: error,
      });
    }
  }
  ...
  async cleanUp() {
    return runCleanup([
      ["campaign", this.campaignId, () => this.deleteCampaign()],
      ["base template", this.baseTemplateId, (id) => this.deleteTemplate(id)],
      ["VIP template", this.vipTemplateId, (id) => this.deleteTemplate(id)],
  ...
  createCampaign() {
    ...
    return new Promise((resolve, reject) => {
      this.pkClient.couponsClient // Connection Pooling //.getCouponsClient() //Single Connection
  ...
  listCoupons() {
    ...
    return new Promise((resolve, reject) => {
      ...
      //gRPC Connection
      const couponStream =
        this.pkClient.couponsClient.listCouponsByCouponCampaign(listRequest);
    ...
    coupon
      ...
      .setPerson(
        new Person()
          ...
          .setEmailaddress(
            this.recipientEmail || "base.billy@dummy.passkit.com",
          ),
      );
    ...
    coupon
      ...
      .setPerson(
        new Person()
          ...
          .setEmailaddress(
            this.recipientEmail || "vip.steve@dummy.passkit.com",
          ),
      );
  ...
  updateCoupon() {
    ...
    coupon
      ...
      .setPerson(new Person().setDisplayname("base"));
  ...
  redeemCoupon() {
    ...
    const coupon = new Coupon();
    coupon.setId(this.baseCouponId);
